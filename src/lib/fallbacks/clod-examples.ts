...
export function getCEOVerdict(idea: string, cmoSummary: string, ctoSummary: string): string {
...
export function getSWE1BuildNarrative(idea: string): { narrative: string; files: { html: string; css: string; js: string } } {
  return {
...
export function getSWE2ReviewNarrative(_idea: string): string {
